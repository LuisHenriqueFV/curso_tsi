...
public class FornecimentoController {
    public static void main(String[] args) {
        ...
        Fornecimento fn1 = new Fornecimento(LocalDateTime.now(), 100, p1.getPrecoDeCusto().multiply(BigDecimal.valueOf(100)), p1, f1);
        System.out.print("+++++ i-a +++++");
        System.out.println(fn1);
        //i-b - fornecimento 30 dias atrás
        Fornecimento fn2 = new Fornecimento(LocalDateTime.now().minusDays(30L), 100, p1.getPrecoDeCusto().multiply(BigDecimal.valueOf(100)), p1, f1);
        System.out.print("+++++ i-b +++++");
        System.out.println(fn2);
        //i-c - fornecimento 60 dias atrás
        Fornecimento fn3 = new Fornecimento(LocalDateTime.now().minusDays(60L), 100, p1.getPrecoDeCusto().multiply(BigDecimal.valueOf(100)), p1, f1);
